...
import { ProductVariantModel } from '../../../aModel/cKisna/aProductManagement/dProductVariantModel';


const productVariantController = (Model=ProductVariantModel, Label="Product Variant") => ({
  // List
